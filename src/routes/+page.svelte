...
<div class="header-section">
  ...
  <h2>Software Engineer at Mercado Libre</h2>
  <p>Democratizing e-commerce and digital financial services in LATAM</p>
  <ul class="list-logo" aria-label="Social media">
  <li>
  <a class="block hover:text-slate-200" href="https://www.linkedin.com/in/wesleynepo/" target="_blank" rel="noreferrer">
  ...
  <li><a href="https://instagram.com/wesleynepo" target="_blank" rel="noreferrer">
